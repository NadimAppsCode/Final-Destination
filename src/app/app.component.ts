...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      ...
      { title: '99 Names of ALLAH(SWT)', component: CommandsPage },
      { title: '99 command of ALLAH(SWT)', component: CommandsPage },
      { title: 'Qabr(Questions)', component: QabrQuestionsPage },
